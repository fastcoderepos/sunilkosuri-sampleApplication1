package com.fastcode.example.addons.scheduler.application.job;

import com.fastcode.example.ExampleApplication;
import com.fastcode.example.addons.scheduler.CGenClassLoader;
import com.fastcode.example.addons.scheduler.application.job.dto.*;
import com.fastcode.example.addons.scheduler.constants.QuartzConstants;
import com.fastcode.example.addons.scheduler.domain.job.IJobRepository;
import com.fastcode.example.addons.scheduler.domain.job.JobEntity;
import com.fastcode.example.addons.scheduler.domain.job.QJobEntity;
import com.fastcode.example.addons.scheduler.domain.jobhistory.IJobHistoryRepository;
import com.fastcode.example.addons.scheduler.domain.jobhistory.JobHistoryEntity;
import com.fastcode.example.addons.scheduler.domain.jobhistory.QJobHistoryEntity;
